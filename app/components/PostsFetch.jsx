...
const PostsFetch = ({ listType, id, filters,submitFilters, sortOption }) => {
    ...
    return (
      <div
        className="container mx-auto px-4 py-6 max-w-4xl h-[100vh] overflow-y-scroll"
            ...
            <div key={e.id} className="relative group">
              ...
              >
                <Post
                  ...
                  location={e.location}
                  price={e.price}
                  model={listType === "cars" ? e.model : null}
                  brand={listType === "cars" ? e.brand : null}
                  year={listType === "cars" ? e.year : null}
                  space={listType === "apartments" ? e.space : null}
                  rooms={listType === "apartments" ? e.rooms : null}
                  furnished={listType === "apartments" ? e.furnished : null}
                  isNew={listType === "laptops" ? e.new : null}
                  ram={listType === "laptops" ? e.ram : null}
                  processor={listType === "laptops" ? e.processor : null}
                  name={listType === "books" ? e.name : null}
                  state={listType === "books" ? e.state : null}
                />
              </Link>
              {userId == e.seller_id && (
                <button
